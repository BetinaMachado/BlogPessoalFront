...
getAllPostagens(): Observable<Postagem[]>{
  return this.http.get<Postagem[]>('https://personalblogbe.herokuapp.com/postagens', this.token)
}

postPostagem(postagem: Postagem): Observable<Postagem>{
  return this.http.post<Postagem>('https://personalblogbe.herokuapp.com/postagens', postagem, this.token)
}
